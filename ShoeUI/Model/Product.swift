...
var products = [
    ...
    Product(productImage: "nike3", productTitle: "Nike Air Force 1 Men's Boot", productPrice: "$120.0", productBG: Color("BG3"), productRaiting: 1),
    ...
    Product(productImage: "nike6", productTitle: "Nike Air Force 1 Low By You Unlocked", productPrice: "$150.0", productBG: Color("BG1"), productRaiting: 4),
